namespace doix.desktop.forms.controls
{
  partial class DataGridDemoForm
  {
    ...
    {
      this.dg = new doix.desktop.forms.controls.DataGridControl();
      this.SuspendLayout();
      // 
      // dg
      // 
      ...
      this.dg.Columns = new doix.desktop.forms.controls.ColumnInfo[0];
      this.dg.Dock = System.Windows.Forms.DockStyle.Fill;
      this.dg.FntPath = null;
      this.dg.Location = new System.Drawing.Point(0, 0);
      this.dg.Margin = new System.Windows.Forms.Padding(0);
      this.dg.MouseWheelHorizontalScrollModifierKeys = doix.desktop.forms.controls.ModifierKeys.Ctrl;
      this.dg.Name = "dg";
      this.dg.Rows = new doix.desktop.forms.controls.RowInfo[0];
      this.dg.ScrollSmoothing = false;
