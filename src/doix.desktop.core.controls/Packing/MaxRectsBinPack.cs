...
namespace doix.desktop.core.controls.Packing
{
  public struct Rect
  {
    public int x;
  ...
  public class MaxRectsBinPack
  {
    ...
    /// <summary> Returns 0 if the two intervals i1 and i2 are disjoint, or the length of their overlap otherwise </summary>
    ...
    void PruneFreeList()
    {
      for (int i = 0; i < freeRectangles.Count; ++i)
        for (int j = i + 1; j < freeRectangles.Count; ++j)
        {
          ...
          var rectangle0 = freeRectangles[i];
          var rectangle1 = freeRectangles[j];

          if (IsContainedIn(ref rectangle0, ref rectangle1))
          {
            freeRectangles.RemoveAt(i);
            --i;
            break;
          ...
          if (IsContainedIn(ref rectangle1, ref rectangle0))
          {
